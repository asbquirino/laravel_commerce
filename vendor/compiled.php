...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->bind('Illuminate\\Contracts\\Auth\\Registrar', 'CodeCommerce\\Services\\Registrar');
    }
}
namespace CodeCommerce\Providers;
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'CodeCommerce\\Commands', 'CodeCommerce\\Handlers\\Commands');
        });
    }
    public function register()
    {
